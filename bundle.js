...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_redux__ = __webpack_require__(29);
...
const reducers = {
  todos: (state = [], action) => {
    switch (action.type) {
      case 'ADD_TODO':
        return [...state, _extends({}, action.text, {
          id: state.length
        })];
      default:
        return state;
  ...
  lists: (state = [], action) => {
    switch (action.type) {
      case 'ADD_LIST':
        return [...state, _extends({}, action.title, {
          id: state.length
        })];
      default:
        return state;
...
const store = Object(__WEBPACK_IMPORTED_MODULE_1_redux__["c" /* createStore */])(Object(__WEBPACK_IMPORTED_MODULE_1_redux__["b" /* combineReducers */])(reducers), window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
...
class List extends __WEBPACK_IMPORTED_MODULE_2_react___default.a.Component {
  constructor(...args) {
    var _temp;

    return _temp = super(...args), this.createTodo = e => {
      e.preventDefault();
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(
        'form',
        { onSubmit: this.createTodo, placeholder: 'Add a TODO' },
        __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('input', { ref: 'text' }),
        __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(
          'button',
          { type: 'submit' },
          'submit'
...
class Board extends __WEBPACK_IMPORTED_MODULE_2_react___default.a.Component {
  constructor(...args) {
    var _temp2;

    return _temp2 = super(...args), this.createList = e => {
      e.preventDefault();
      ...
      return this.props.lists.map(list => {
        return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(List, { listId: list.id })
        );
      });
    }, _temp2;
  }
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('input', { ref: 'text', placeholder: 'Add a List' }),
        __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(
          'button',
          { type: 'submit' },
          'submit'
...
List = Object(__WEBPACK_IMPORTED_MODULE_0_react_redux__["b" /* connect */])(mapStateToProps)(List);
Board = Object(__WEBPACK_IMPORTED_MODULE_0_react_redux__["b" /* connect */])(mapStateToProps)(Board);

class App extends __WEBPACK_IMPORTED_MODULE_2_react___default.a.Component {
  render() {
    return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(
      __WEBPACK_IMPORTED_MODULE_0_react_redux__["a" /* Provider */],
      { store: store },
      __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(Board, null)
    );
  }
}

__WEBPACK_IMPORTED_MODULE_3_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(App, null), document.querySelector('#app'));
